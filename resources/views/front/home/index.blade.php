...
@section('content')
    <section class="box-action">
        <div class="container">
            <div class="title">
                <p class="lead"><marquee>Implement an action bar at any section of the page!</marquee></p>
            </div>
            <div class="button">
                    ...
                    <div class="col-md-4">
                        <div class="item-service border-right">
                            <div class="row head-service">
                                ...
                                <div class="col-md-10">
                                    <h4>High Quality</h4>
                                    <h5>Point of Sales (POS) Software</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="item-service border-right">
                            <div class="row head-service">
                                ...
                                <div class="col-md-10">
                                    <h4>High Quality</h4>
                                    <h5>Diagnostic Center Management Software</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="item-service border-right">
                            <div class="row head-service">
                                ...
                                <div class="col-md-10">
                                    <h4>High Quality</h4>
                                    <h5>Restaurant Management Software</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="item-service">
                            <div class="row head-service">
                                ...
                                <div class="col-md-10">
                                    <h4>High Quality</h4>
                                    <h5>Prescription Management Software</h5>
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="box">
                            ...
                            <li class="row">
                                <!-- Date -->
                                <div class="col-md-3">
                                    <div class="date"><span style="background-color: #00A8FF;"><i class="fa fa-calendar-o" ></i>Sep</span>15</div>
                                </div>
                                <!-- End Date -->
                                <div class="col-md-7">
                                    <div class="info">
